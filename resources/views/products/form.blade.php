...
<div class="container">
    ...
    <div class="form-group">
        {{ Form::number('pricing', (is_object($product->cat) && $product->cat->title == 'Promociones') ? $product->promotion_pricing : $product->pricing, ['class' => 'form-control', 'placeholder'=>'Precio de tu producto....']) }}
    </div>
    <div class="form-group">
        {{ Form::file('cover') }}
    </div>
