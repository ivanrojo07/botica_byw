    ...
    <strong>
        ...
        <p class="costo orangep">
            ...
            @else
                ...
                $  {{number_format((($product["precio_publico"]+($product["precio_publico"]*($product["iva"]/100))+($product["precio_publico"]*($product["ieps"]/100))+($product["precio_publico"]*($product["impuesto_3"]/100)))/$cambio[0]),2)}}  USD
