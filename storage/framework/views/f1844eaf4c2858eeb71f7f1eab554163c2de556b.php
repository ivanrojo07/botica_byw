...
<header class="major margin-top">
                            ...
                            <h2 class="margin-bottom1 header-text">Inicia sesión y ¡conoce nuestro catálogo de Farmacia!
                                ...
                                <!-- Sidebar -->
                                    ...
                                    <section id="sidebar" class="color-grey">
                                        ...
                                        <section>
                                            ...
                                            <h3 class="color-grey font-ch"><a href="<?php echo e(url('/register')); ?>">Crea tu Cuenta</a></h3>
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-md-offset-4">
                                ...
                                <a class="btn btn-link link" href="<?php echo e(route('password.request')); ?>">
